...
type Publication struct {
	...
	// UpdatedAt When this publication's details, definition, landing page or thumbnail last changed, whichever is latest.
	UpdatedAt *time.Time `json:"updatedAt,omitempty" yaml:"updatedAt,omitempty"`
	UpdatedBy *string    `json:"updatedBy,omitempty" yaml:"updatedBy,omitempty"`
	Version   *string    `json:"version,omitempty" yaml:"version,omitempty"`
}
...
type PublicationDraftDetails struct {
	...
	// HasLandingPage Whether this draft stores a landing page of its own.
	HasLandingPage *bool `json:"hasLandingPage,omitempty" yaml:"hasLandingPage,omitempty"`

	// HasThumbnail Whether this draft stores a thumbnail of its own.
	HasThumbnail *bool `json:"hasThumbnail,omitempty" yaml:"hasThumbnail,omitempty"`

	// Labels API Portal label handles controlling which portal views show this listing. An unknown handle is rejected by the portal at publish time.
	Labels *[]string `json:"labels,omitempty" yaml:"labels,omitempty"`

	// Owners Contacts published alongside the listing. Omitting them on a save clears the portal's own values on next publish.
	Owners *struct {
		BusinessOwner       *string              `json:"businessOwner,omitempty" yaml:"businessOwner,omitempty"`
		BusinessOwnerEmail  *openapi_types.Email `json:"businessOwnerEmail,omitempty" yaml:"businessOwnerEmail,omitempty"`
		TechnicalOwner      *string              `json:"technicalOwner,omitempty" yaml:"technicalOwner,omitempty"`
	...
	// UpdatedAt When this draft's details, definition, landing page or thumbnail last changed, whichever is latest.
	UpdatedAt *time.Time `json:"updatedAt,omitempty" yaml:"updatedAt,omitempty"`
	UpdatedBy *string    `json:"updatedBy,omitempty" yaml:"updatedBy,omitempty"`
	Version   *string    `json:"version,omitempty" yaml:"version,omitempty"`
}
...
type PublicationSummaryResponse struct {
	// Count Number of portals in current response
	Count      int                      `binding:"required" json:"count" yaml:"count"`
...
type DefinitionResponse = openapi_types.File
...
type ListAPIPublicationsParams struct {
	// ApiType The API's type, resolved at runtime against the registered artifact types — a plugin-contributed type is accepted only on a build that includes it. Known in this specification: `rest-api`. An unrecognized value returns 404.
	ApiType ApiTypeQ `form:"apiType" json:"apiType" yaml:"apiType"`

	// ApiId **API ID** consisting of the **handle** (unique identifier) of the API, unique per
	// organization within its own type.
...
type SaveAPIPublicationDraftJSONRequestBody = PublicationDraftDetails
